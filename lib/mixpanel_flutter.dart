...
class Mixpanel {
  ...
  void setServerURL(String serverURL) {
    if (Platform.isIOS) {
      if (_MixpanelHelper.isValidString(serverURL)) {
        _channel.invokeMethod<void>('setServerURL',
            <String, dynamic>{'serverURL': serverURL});
      } else {
        developer.log('`setServerURL` failed: serverURL cannot be blank', name: 'mixpanel');
      }
    }
  }
  ...
  void setLoggingEnabled(bool loggingEnabled) {
    if (Platform.isIOS) {
      if (loggingEnabled != null) {
        ...
        developer.log('`setLoggingEnabled` failed: loggingEnabled cannot be blank', name: 'mixpanel');
      }
    }
  }
  ...
  void alias(String alias, String distinctId) {
    ...
    if (!_MixpanelHelper.isValidString(distinctId)) {
      developer.log('`alias` failed: distinctId cannot be blank', name: 'mixpanel');
      return;
    }
    _channel.invokeMethod<void>(
  ...
  void trackWithGroups(String eventName, Map<String, dynamic> properties, Map<String, dynamic> groups) {
    if (_MixpanelHelper.isValidString(eventName)) {
      _channel.invokeMethod<void>('trackWithGroups',
          <String, dynamic>{'eventName': eventName, 'properties': properties, 'groups': groups});
    } else {
      developer.log('`trackWithGroups` failed: eventName cannot be blank', name: 'mixpanel');
    }
  }
  ...
  void setGroup(String groupKey, dynamic groupID) {
    if (_MixpanelHelper.isValidString(groupKey)) {
      ...
      developer.log('`setGroup` failed: groupKey cannot be blank', name: 'mixpanel');
    }
  }
  ...
  void addGroup(String groupKey, dynamic groupID) {
    if (_MixpanelHelper.isValidString(groupKey)) {
      ...
      developer.log('`addGroup` failed: groupKey cannot be blank', name: 'mixpanel');
    }
  }
  ...
  void removeGroup(String groupKey, dynamic groupID) {
    if (_MixpanelHelper.isValidString(groupKey)) {
      ...
      developer.log('`removeGroup` failed: groupKey cannot be blank', name: 'mixpanel');
    }
  }
  ...
  void deleteGroup(String groupKey, dynamic groupID) {
    if (_MixpanelHelper.isValidString(groupKey)) {
      ...
      developer.log('`deleteGroup` failed: groupKey cannot be blank', name: 'mixpanel');
    }
  }
  ...
  void unregisterSuperProperty(String propertyName) {
    if (_MixpanelHelper.isValidString(propertyName)) {
      ...
      developer.log('`unregisterSuperProperty` failed: propertyName cannot be blank', name: 'mixpanel');
    }
  }
  ...
  void timeEvent(String eventName) {
    if (_MixpanelHelper.isValidString(eventName)) {
      _channel.invokeMethod<void>('timeEvent', <String, dynamic>{'eventName': eventName});
    } else {
      developer.log('`timeEvent` failed: eventName cannot be blank', name: 'mixpanel');
    }
  }
...
class People {
  ...
  void set(String prop, dynamic to) {
    if (_MixpanelHelper.isValidString(prop)) {
      ...
      developer.log('`people set` failed: prop cannot be blank', name: 'mixpanel');
    }
  }
  ...
  void setOnce(String prop, dynamic to) {
    if (_MixpanelHelper.isValidString(prop)) {
      ...
      developer.log('`people setOnce` failed: prop cannot be blank', name: 'mixpanel');
    }
  }
  ...
  void increment(String prop, double by) {
    ...
    if (_MixpanelHelper.isValidString(prop)) {
      ...
      developer.log('`people increment` failed: prop cannot be blank', name: 'mixpanel');
    }
  }
  ...
  void append(String name, dynamic value) {
    if (_MixpanelHelper.isValidString(name)) {
      ...
      developer.log('`people append` failed: name cannot be blank', name: 'mixpanel');
    }
  }
  ...
  void union(String name, dynamic value) {
    if (_MixpanelHelper.isValidString(name)) {
      if (Platform.isIOS) {
        Map<String, dynamic> properties = {name: value};
      ...
      developer.log('`people union` failed: name cannot be blank', name: 'mixpanel');
    }
  }
  ...
  void remove(String name, dynamic value) {
    if (_MixpanelHelper.isValidString(name)) {
      ...
      developer.log('`people remove` failed: name cannot be blank', name: 'mixpanel');
    }
  }
  ...
  void unset(String name) {
    if (_MixpanelHelper.isValidString(name)) {
      _channel.invokeMethod<void>('unset',
          <String, dynamic>{'token': this._token, 'name': name});
    } else {
      developer.log('`people unset` failed: name cannot be blank', name: 'mixpanel');
    }
  }
  ...
  void trackCharge(double amount, {Map<String, dynamic> properties}) {
    _channel.invokeMethod<void>('trackCharge',
          <String, dynamic>{'token': this._token, 'amount': amount, 'properties': properties});
  }

  /// Permanently clear the whole transaction history for the identified people profile.
  void clearCharges() {
    _channel.invokeMethod<void>('clearCharges',
        <String, dynamic>{'token': this._token});
  }
  ...
  void deleteUser() {
    _channel.invokeMethod<void>('deleteUser',
        <String, dynamic>{'token': this._token});
  }
}
...
class MixpanelGroup {
  ...
  void set(String prop, String to) {
    if (_MixpanelHelper.isValidString(prop)) {
      ...
      developer.log('`group set` failed: prop cannot be blank', name: 'mixpanel');
    }
  }
  ...
  void setOnce(String prop, String to) {
    if (_MixpanelHelper.isValidString(prop)) {
      ...
      developer.log('`group setOnce` failed: prop cannot be blank', name: 'mixpanel');
    }
  }
  ...
  void unset(String prop) {
    if (_MixpanelHelper.isValidString(prop)) {
      ...
      developer.log('`group unset` failed: prop cannot be blank', name: 'mixpanel');
    }
  }
  ...
  void remove(String name, dynamic value) {
    if (_MixpanelHelper.isValidString(name)) {
      ...
      developer.log('`group remove` failed: name cannot be blank', name: 'mixpanel');
    }
  }
  ...
  ///
  /// * [name] name of the list-valued property to set or modify
  /// * [value] value an array of values to add to the property value if not already present
  void union(name, dynamic value) {
    if (_MixpanelHelper.isValidString(name)) {
      ...
      developer.log('`group union` failed: name cannot be blank', name: 'mixpanel');
    }
  }
