...
public class MixpanelFlutterPlugin implements FlutterPlugin, MethodCallHandler {
    ...
    private void handleSetGroups(MethodCall call, Result result) {
        String groupKey = call.argument("groupKey");
        JSONArray groupIDs = call.argument("groupIDs");
        mixpanel.setGroup(groupKey, groupIDs);
        result.success(null);
    }
