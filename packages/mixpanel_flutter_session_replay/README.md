...
##### _July 20, 2026_ - [session-replay-v1.1.1](https://github.com/mixpanel/mixpanel-flutter/releases/tag/session-replay-v1.1.1)
...
```yaml
dependencies:
  mixpanel_flutter_session_replay: 1.1.1
```
