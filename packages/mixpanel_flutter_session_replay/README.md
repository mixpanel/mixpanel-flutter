...
##### _September 17, 2026_ - [session-replay-v1.2.0](https://github.com/mixpanel/mixpanel-flutter/releases/tag/session-replay-v1.2.0)
...
```yaml
dependencies:
  mixpanel_flutter_session_replay: 1.2.0
```
