...
class RageClickTracker {
  ...
  bool record(double x, double y, Duration time) {
    ...
    final cutoff = time - Duration(milliseconds: options.timeWindowMs);
    ...
    final radiusSquared = options.radius * options.radius;
    var count = 0;
    ...
    if (count < options.clickThreshold) return false;
    reset();
    return true;
  }
